...
## Define high water events in YEARS (these must be years) and add event year to high water marks dataframe.
## NOTE: If your events are not years, DO NOT USE line 86 or 87.  
...
##If you are working with a single profile or events that are not classified by years (e.g.25% duration flows or similar), INSTEAD add a column which specifies the event, using the following code.

#high_water_events <- c("25")
