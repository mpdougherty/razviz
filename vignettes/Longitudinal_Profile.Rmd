...
## Longitudinal Profile Report (Entire Reach)
In this step we'll call the longitudinal profile graph report for the entire reach of the river that is in the data that was orginally uploaded.
...
long_plot_pages_filtered <- razviz::long_plot_pages(hydro_model_filtered, high_water_events_filtered, miles_per_plot_filtered)
