...
## Longitudinal Profile (Hydrualic Parameter ONLY)
...
### Longitudinal Profile Report (Hydrualic Parameter ONLY)
...
```
### Gage locations
In this step we'll prepare the gage dataset. (NOTE: If you'd like to have the gage identified without gage boxes, please add the gage as a river feature.)
...
## Longitudinal Profile Report (Filtered Reach)
